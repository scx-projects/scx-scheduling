package cool.scx.scheduling.one_time;
...
/// @author scx567888
/// @version 0.0.1
public class OneTimeScheduleTaskImpl implements OneTimeScheduleTask {
    ...
    public OneTimeScheduleTaskImpl() {
    ...
    @Override
    public OneTimeScheduleTask timer(ScxTimer timer) {
        this.timer = timer;
        return this;
    }
